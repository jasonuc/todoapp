...
function InputDiv() {
  ...
  return (
    <div className='border-b-2 border-solid w-[90%] flex items-center justify-center h-16 gap-x-3 md:gap-x-5'>
        ...
        <button onClick={AddTask} className='bg-secondary text-primary w-28 md:w-24 h-[60%] rounded-md font-bold shadow-md hover:shadow-lg hover:shadow-secondary'>Add</button>
    </div>
  )
}
