...
function InputDiv() {
  ...
  return (
    <div className='border-b-2 border-solid w-[90%] flex items-center justify-center h-16 gap-x-3 md:gap-x-5'>
        ...
        <button onClick={AddTask} className='bg-secondary text-primary w-14 h-[60%] md:h-[80%] font-bold shadow-md hover:shadow-lg hover:shadow-secondary flex justify-center items-center rounded-full'><AiOutlinePlus size={30} /></button>
    </div>
  )
}
