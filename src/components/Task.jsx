...
function Task({ id, task, datetime }) {
    ...
    return (
        <div className="w-[100%] min-h-[3rem] border-2 border-solid rounded-md flex ">
            <p className=' w-[90%] md:w-[95%] h-[100%] p-2 text-white flex flex-wrap overflow-ellipsis items-center font-bold border-r-2 md:border-none rounded-tr-md rounded-br-md'>{`${task} | ${datetime}`}</p>
